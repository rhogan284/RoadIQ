...
MAX_TRAIN_IMAGES = 2000  # CPU-feasible subset; full train split is ~26,900 images
VAL_SUBSET_SIZE = 400  # separate small val slice for per-epoch training checks — see data_fast.yaml below
RANDOM_SEED = 42
